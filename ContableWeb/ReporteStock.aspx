...
<asp:Content ID="Content2" ContentPlaceHolderID="contentCuerpo" runat="server">
 ...
 <form id="frmReporteStock" runat="server" class="stdform" >
        ...
        <span class="field"><asp:TextBox ID="txtProducto" runat="server" Width="400px"></asp:TextBox></span>
...
<asp:Repeater ID="grilla" runat="server">
    <HeaderTemplate>
        ...
        <thead>
            <tr>
                ...
                <th class="head0">Stock Irigoyen</th>
                <th class="head0">Stock San Isidro</th>
                <th class="head0">Stock Total</th>
    ...
    <ItemTemplate>
            <tr class="">
                ...
                <td><%# DataBinder.Eval(Container.DataItem, "stockIrigoyen")%></td>
                <td><%# DataBinder.Eval(Container.DataItem, "stockSI")%></td>
                <td><%# DataBinder.Eval(Container.DataItem, "stockTotal")%></td>
