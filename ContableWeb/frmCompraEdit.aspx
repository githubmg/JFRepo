...
<asp:Content ID="Content2" ContentPlaceHolderID="contentCuerpo" runat="server">
 <div class="contenttitle"><h2 class="form"><span>Compras</span></h2></div>
    ...
    <form runat="server" id="frmPedidoEdit" class="stdform" action="" method="post">
        ...
        <label>Percepción ganancias</label>
        <span class="field">$&nbsp; <asp:TextBox ID="txtGanancias" runat="server" CssClass="mediuminput"></asp:TextBox></span>
        
        <label>Percepción IIBB</label>
        <span class="field">$&nbsp; <asp:TextBox ID="txtIIBB" runat="server" CssClass="mediuminput"></asp:TextBox></span>

        <label>Percepción IVA</label>
        <span class="field">$&nbsp; <asp:TextBox ID="txtIva" runat="server" CssClass="mediuminput"></asp:TextBox></span>
