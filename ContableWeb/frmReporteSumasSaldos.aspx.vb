...
Partial Public Class frmReporteSumasSaldos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.lblTitulo.Text = "Sumas y Saldos"
    ...
    Private Sub cmdVerCtaCte_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdVerReporte.Click
        If ValidarForm() Then
            Me.Tabla = Sistema.ReporteSumasSaldos(CType(Me.txtFechaDesde.Text, Date), CType(Me.txtFechaHasta.Text, Date))
    ...
    '    Utiles.ReportviewerToPdf(Me.Tabla, Server.MapPath("reportes\reporteSumasSaldos.rdlc"), "SumasSaldos")
    'End Sub

    'Private Sub lnkExpoXLS_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkExpoXLS.Click
    '    Utiles.ReportviewerToExcel(Me.Tabla, Server.MapPath("reportes\reporteSumasSaldos.rdlc"), "SumasSaldos")
    'End Sub
