...
Partial Public Class frmCtaCteProveedor
    ...
    Private Sub cmdVerCtaCte_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdVerCtaCte.Click
        If ValidarForm() Then
            Me.Tabla = Sistema.VistaCtaCteProveedor(Me.Proveedor, CType(Me.txtFechaDesde.Text, Date), CType(Me.txtFechaHasta.Text, Date))
