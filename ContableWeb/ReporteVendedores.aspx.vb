...
Public Class ReporteVendedores
    ...
    Private Function ValidarForm() As Boolean
        ...
        Return esValido
    End Function
    Private Sub cmdVerValores_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdVerReporte.Click
        If ValidarForm() Then
            Me.Tabla = Sistema.VistaVentasVendedor(Me.txtFechaDesde.Text, Me.txtFechaHasta.Text, cmbVendedor.SelectedValue)
    ...
    Protected Sub lnkExpoPDF_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExpoPDF.Click
        Response.Redirect("frmViewer.aspx?tipo=VE&desde=" & txtFechaDesde.Text & "&hasta=" & txtFechaHasta.Text & "&idVendedor=" & cmbVendedor.SelectedValue)
    End Sub
    Private Sub lnkExpoXLS_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkExpoXLS.Click
        Response.Redirect("frmViewer.aspx?tipo=VEEX&desde=" & txtFechaDesde.Text & "&hasta=" & txtFechaHasta.Text & "&idVendedor=" & cmbVendedor.SelectedValue)
    End Sub
    Private Sub CargarComboVendedor()
        ...
        cmbVendedor.Items.Add(New ListItem("Todos", ""))
