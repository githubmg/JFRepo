   ...
   <asp:Repeater ID="grilla" runat="server">
    <HeaderTemplate>
        ...
        <thead>
            <tr>
                ...
                <th class="head0">Ubicación Stock</th>
                <th class="head0">Tipo</th>
                <th class="head0">Per. Gcia</th>
                <th class="head0">Per. IVA</th>
                <th class="head0">Per. IIBB</th>
    ...
    <ItemTemplate>
            <tr class="">
                ...
                <td><%#String.Format("{0:n2}", DataBinder.Eval(Container.DataItem, "pendiente"))%></td>
                <td><%#DataBinder.Eval(Container.DataItem, "ubicacionStock")%></td>
                <td><%#DataBinder.Eval(Container.DataItem, "tipoOrden")%></td>
                <td><%#DataBinder.Eval(Container.DataItem, "percepcionGanancias")%></td>
                <td><%#DataBinder.Eval(Container.DataItem, "percepcionIva")%></td>
                <td><%#DataBinder.Eval(Container.DataItem, "percepcionIIBB")%></td>
                <td><%#String.Format("{0:n2}", DataBinder.Eval(Container.DataItem, "total"))%></td>
