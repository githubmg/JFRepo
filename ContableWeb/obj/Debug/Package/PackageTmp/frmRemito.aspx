...
<form runat="server" id="frmRemito" class="">
    ...
    <asp:HiddenField ID="hfSeleccionados" runat="server" />
   <asp:Repeater ID="grilla" runat="server">
    ...
    <div id="tabs-1">
        ...
        <label>Observaciones</label>
            <span class="field"><asp:TextBox ID="txtObservaciones" runat="server" MaxLength="100" Width="300px"></asp:TextBox></span>
        </div>
        <br />
    </div>
