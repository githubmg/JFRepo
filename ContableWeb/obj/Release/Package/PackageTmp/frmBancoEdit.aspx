<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ContableWeb.Master" CodeBehind="frmBancoEdit.aspx.vb" Inherits="ContableWeb.frmBancoEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentTitulo" runat="server">
Información del Banco
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentCuerpo" runat="server">

<div class="contenttitle"><h2 class="form"><span>Banco</span></h2></div>
<br />
<form runat="server" id="frmBancoEdit" class="stdform" action="" method="post">
