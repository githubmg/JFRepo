 ...
 <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"/>
    ...
    <div id="tabs">
        ...
        <span class="field"><asp:DropDownList ID="cmbTipoMovimiento" runat="server" 
         ...
         <asp:UpdatePanel ID="pnlUbicaciones" runat="server" Visible="False" >
        <ContentTemplate>
          <div class="widgetbox" style="width:75%; position:relative; margin-left:220px;">
            <div class="title"><h2 class="general"><span>Origen y Destino</span></h2></div>
            <div class="widgetcontent">
            <label>Ubicación de origen </label>
            <span class="field"><asp:DropDownList ID="cmbOrigen" runat="server" 
                AutoPostBack="False"></asp:DropDownList></span>     
            <label>Ubicación de destino </label>
            <span class="field"><asp:DropDownList ID="cmbDestino" runat="server" 
                AutoPostBack="False"></asp:DropDownList></span>     
             </div>
             </div>
            </ContentTemplate>
            </asp:UpdatePanel>
     <asp:UpdatePanel ID="pnlUbicacion" runat="server" Visible="true" >
        <ContentTemplate>
          <div class="widgetbox" style="width:75%; position:relative; margin-left:220px;">
            <div class="title"><h2 class="general"><span>Ubicación del Stock</span></h2></div>
            <div class="widgetcontent">
            <label>Ubicación</label>
            <span class="field"><asp:DropDownList ID="cmbUbicacionStock" runat="server" 
                AutoPostBack="False"></asp:DropDownList></span>
                  </div>
             </div>     
        </ContentTemplate>
