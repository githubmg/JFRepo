<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ContableWeb.Master" CodeBehind="frmCtaCteSocio.aspx.vb" Inherits="ContableWeb.frmCtaCteSocio" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentTitulo" runat="server">
    <asp:Label ID="lblSocio" runat="server" Text="Label" />
</asp:Content>
...
<%--    <rsweb:ReportViewer ID="ReportViewer1" runat="server"
        ...
        <LocalReport ReportPath="reportes\reporteCtaCteSocio.rdlc"></LocalReport>
    </rsweb:ReportViewer>--%>
