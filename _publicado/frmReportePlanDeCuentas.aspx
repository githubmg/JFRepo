<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ContableWeb.Master" CodeBehind="frmReportePlanDeCuentas.aspx.vb" Inherits="ContableWeb.frmReportePlanDeCuentas" %>
...
<script language="javascript" type="text/javascript">
    ...
    <form id="frmCtaCteSocio" runat="server" class="stdform" >
        ...
        <span class="field"><asp:TextBox ID="txtCuentaDesde" runat="server" CssClass="largeinput"></asp:TextBox></span>
        
        <label>Hasta Cuenta:</label>
        <span class="field"><asp:TextBox ID="txtCuentaHasta" runat="server" CssClass="largeinput"></asp:TextBox></span>
        ...
        <div class="contenttitle radiusbottom0">
            <h2 class="table"><span>Plan de cuentas</span></h2>
        </div>
        <br />
        ...
        <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" 
            TargetControlID="txtCuentaDesde"   
        ...
        <asp:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" 
            TargetControlID="txtCuentaHasta"   
            ServiceMethod="VistaCuenta"
            ServicePath="servicios.asmx"
            MinimumPrefixLength="2" 
            CompletionListItemCssClass="select"
    ...
    <HeaderTemplate>
        ...
        <thead>
            <tr>
                ...
                <th class="head1">Centro de Costos</th>
                <th class="head1">Imputable</th>
                <th class="head0">Ajustable</th>
            </tr>
        </thead>
    </HeaderTemplate>
    <ItemTemplate>
            <tr class="">
                ...
                <td><%#DataBinder.Eval(Container.DataItem, "imputable")%></td>
                <td><%#DataBinder.Eval(Container.DataItem, "ajustable")%></td>
            </tr>
    </ItemTemplate>
    <FooterTemplate>
            <tfoot>
